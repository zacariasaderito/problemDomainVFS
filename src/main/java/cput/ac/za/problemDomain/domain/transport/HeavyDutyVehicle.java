...
public class HeavyDutyVehicle implements Vehicle {
    ...
    private HeavyDutyVehicle(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public HeavyDutyVehicle build()
        {
            return new HeavyDutyVehicle(this);
        }
    ...
    public String toString() {
        return "HeavyDutyVehicleFactory{" +
